...
namespace Digital_sign
{
    public partial class Form7 : Form
    {
        ...
        void bookkeep()
        {
            ...
            adapter = new SqlDataAdapter("select employee_respons_id as Код_ответственного_сотрудника, e.name as Сотрудники, e.phone_number as Номер_телефона, e.post as Должность from bookkeep b join employee e on b.employee_id=e.employee_id;", connection);
